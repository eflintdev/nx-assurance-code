...
export const CONTENT_PARAGRAPHS_DATA = {
  main: [
  ...
  bottom: [
    ...
    'Give us a call at 800-516-9242 to see how you can save on motorhome or RV insurance through Plymouth Rock in New Jersey.'
  ]
};
